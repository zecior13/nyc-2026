...
const DAY_MAP_CONFIGS = {
  ...
  "2026-08-23": { title:"Hotel → Guggenheim → Village → Blue Note", view:[150,230,580,850], points:[
    {panel:"overview",title:"Hotel",note:"Śniadanie i wyjazd na Upper East Side",x:430,y:790,icon:"H"},{panel:"guggenheim",title:"Guggenheim",note:"10:30–12:30 · architektura i kolekcja",x:590,y:480,icon:"◌"},{panel:"food",title:"Szybki lunch",note:"Punkt 1 · lekki posiłek w Village",x:445,y:995,icon:"1"},{panel:"route",key:"village-stop-0",title:"Washington Sq.",note:"Punkt 2 · łuk, NYU i scena uliczna",x:470,y:1025,icon:"2"},{panel:"route",key:"village-stop-1",title:"Jefferson i Commerce",note:"Punkt 3 · kręte ulice West Village",x:430,y:1000,icon:"3"},{panel:"route",key:"village-stop-2",title:"Perry i Friends",note:"Punkt 4 · opcjonalny moduł serialowy",x:405,y:985,icon:"4"},{panel:"route",key:"village-stop-3",title:"Stonewall",note:"Punkt 5 · historyczny przystanek spaceru",x:450,y:1015,icon:"5"},{panel:"route",key:"village-stop-4",title:"Kawa",note:"Punkt 6 · odpoczynek przed klubem",x:485,y:1000,icon:"6"},{panel:"bluenote",title:"Blue Note",note:"Hiromi · wejście i koncert",x:485,y:1030,icon:"♪"}
  ...
  "2026-08-26": { title:"Midtown → Long Island City → Flushing", view:[380,600,482,300], points:[
    {panel:"overview",title:"Hotel",note:"Start po zachodniej stronie East River, w Midtown Manhattan",x:430,y:790,icon:"H"},{panel:"route",key:"q-stop-0",title:"Gantry Plaza",note:"Punkt 1 · nabrzeże Long Island City po stronie Queens",x:665,y:760,icon:"1"},{panel:"route",key:"q-stop-1",title:"Pepsi-Cola Sign",note:"Punkt 2 · krótki spacer na północ nabrzeżem",x:675,y:720,icon:"2"},{panel:"route",key:"q-stop-3",title:"Flushing",note:"Punkt 3 · jedzenie; dalej na wschód, przy krawędzi planszy",x:835,y:690,icon:"3"},{panel:"route",key:"q-stop-4",title:"Unisphere",note:"Punkt 4 · dziedzictwo World’s Fair",x:805,y:790,icon:"4"},{panel:"tennis",title:"US Open",note:"Punkt 5 · kompleks leży na północ od Unisphere",x:785,y:735,icon:"5"},{panel:"links",title:"Hotel · powrót",note:"Powrót metrem po meczu",x:445,y:800,icon:"H"}
